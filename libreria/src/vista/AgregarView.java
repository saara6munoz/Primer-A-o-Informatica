...
//Solo llama a metodos del controlador
public class AgregarView extends javax.swing.JFrame {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        String titulo, autor, dia, mes, acno, fechaStr; //atributos para llenar la tabla, mas bien cabeceras
        Date fecha;
        int precio;
        boolean disponible;
        ...
        if (libroDAO.getLibroById(libro.getIdLibro()).getAutor() == null) {
